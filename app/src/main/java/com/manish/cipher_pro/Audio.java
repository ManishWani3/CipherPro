...
//    private static final String FILE_NAME_ENC = "aud_enc.txt";
//    private static final String FILE_NAME_DEC = "aud_dec.mp3";
//    Button encro_image, button2;
...
//        pathuu = findViewById(R.id.editTextTextMultiLine1);
...
//                if (encro_image.getText() == "Encrypt Audio") {
//                    startencSearch();
//                } else {
//                    startdecSearch();
//                }
...
//                encro_image.setText("Encrypt Audio");
...
//                encro_image.setText("Decrypt Audio");
...
//                    }
//                    try {
////                        bitmap = MediaStore.Images.Media.getBitmap(Audio.this.getContentResolver(), uri);
////                        ByteArrayOutputStream stream = new ByteArrayOutputStream();
////                        bitmap.compress(Bitmap.CompressFormat.PNG, 100, stream);
////                        InputStream is = new ByteArrayInputStream(stream.toByteArray());
//                        InputStream is = getContentResolver().openInputStream(uri);
//
//                        File outputFileEncrypt0 = new File(Environment.getExternalStorageDirectory(), "Cipher-Pro/Audios");
...
//                        Toast.makeText(Audio.this, "Encrypted", Toast.LENGTH_SHORT).show();
//
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
...
//                        Toast.makeText(Audio.this, "Decrypted", Toast.LENGTH_SHORT).show();
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
//                }
...
public class Audio extends AppCompatActivity {
    ...
    private static final String FILE_NAME_DEC = System.currentTimeMillis() + ".mp3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(Audio.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ActivityCompat.requestPermissions(Audio.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 88);
                }
            }
        });
        ...
        encro_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((encro_image.getText()) == "ENCRYPT & UPLOAD") {
                    ...
                    try {
//                        bitmap = MediaStore.Images.Media.getBitmap(Video.this.getContentResolver(), uri);
//                        ByteArrayOutputStream stream = new ByteArrayOutputStream();
...
//                                outputFileEncrypt0.mkdirs();
                        ...
                        if (uri1 != null) {
                            ...
                            Toast.makeText(Audio.this, "Audio is not yet encrypted", Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    ...
                    try {
                        File outputFileDecrypt0 = new File(Environment.getExternalStorageDirectory(), "Cipher-Pro/Audios");
                        if (!outputFileDecrypt0.exists()) {
//                              outputFileEncrypt0.mkdirs();
                            if (!outputFileDecrypt0.mkdirs()) {
                                Log.d("App", "failed to create directory");
                        ...
                        Algorithm.decrypt_files(secretkey1.getText().toString(), iv1.getText().toString(), iss, new FileOutputStream(outputFileDecrypt));
                        Toast.makeText(Audio.this, "Decrypted Successfully", Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
        ...
        share_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Audio.this, SendMessages.class);
    ...
    private void uploadAudio(Uri uri1) {
        ...
        String En_audioName = System.currentTimeMillis() + ".txt";
        mStorageRef = storage.getReference();
        mStorageRef.child("Encrypted_Audios").child(En_audioName).putFile(uri1)
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        task.addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(Audio.this, "Failed to upload file, Try again!", Toast.LENGTH_SHORT).show();
                            }
                        });
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 88 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(Audio.this, "Please provide permission", Toast.LENGTH_SHORT).show();
        }
    }
}
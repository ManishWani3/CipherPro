...
//    private static final String FILE_NAME_DEC = System.currentTimeMillis() + ".mp4";
//
//    Button encro_image, button2, share_button;
...
//                if (encro_image.getText() == "Encrypt Video") {
//                    startencSearch();
//
//                } else {
//                    startdecSearch();
...
//                encro_image.setText("Encrypt Video");
...
//                encro_image.setText("Decrypt Video");
...
//
//                        File outputFileEncrypt0 = new File(Environment.getExternalStorageDirectory(), "Cipher-Pro/Videos");
...
//                        Toast.makeText(Video.this, "Encrypted", Toast.LENGTH_SHORT).show();
//
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
...
//                    }
//                    try {
//                        File outputFileDecrypt0 = new File(Environment.getExternalStorageDirectory(), "Cipher-Pro/Videos");
...
public class Video extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(Video.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ActivityCompat.requestPermissions(Video.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 88);
                }
            }
        });
...
//                                outputFileEncrypt0.mkdirs();
                        ...
                        if (uri1 != null) {
                            ...
                            Toast.makeText(Video.this, "Video is not yet encrypted", Toast.LENGTH_SHORT).show();
                        }
...
//                              outputFileEncrypt0.mkdirs();
                        ...
                        Algorithm.decrypt_files(secretkey1.getText().toString(), iv1.getText().toString(), iss, new FileOutputStream(outputFileDecrypt));
                        Toast.makeText(Video.this, "Decrypted Successfully", Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
        ...
        share_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Video.this, SendMessages.class);
    ...
    private void uploadVideo(Uri uri1) {
        ...
        String En_videoName = System.currentTimeMillis() + ".txt";
        mStorageRef = storage.getReference();
        mStorageRef.child("Encrypted_Videos").child(En_videoName).putFile(uri1)
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        task.addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(Video.this, "Failed to upload file, Try again!", Toast.LENGTH_SHORT).show();
                            }
                        });
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 88 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(Video.this, "Please provide permission", Toast.LENGTH_SHORT).show();
        }
    }
}
